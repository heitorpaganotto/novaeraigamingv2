      ...
      <div className="space-y-4">
        <Card className="bg-background border-border shadow-card">
          <CardContent className="grid grid-cols-2 gap-4">
            <p className="text-sm text-muted-foreground">Nome:</p>
            <p className="font-medium text-foreground">{currentSubmission.nome}</p>

            <p className="text-sm text-muted-foreground">Email:</p>
            <p className="font-medium text-foreground break-all">{currentSubmission.email}</p>

            <p className="text-sm text-muted-foreground">Telefone:</p>
            <p className="font-medium text-foreground">{currentSubmission.telefone}</p>

            <p className="text-sm text-muted-foreground">Data:</p>
            <p className="font-medium text-foreground">{currentSubmission.data}</p>

            <p className="text-sm text-muted-foreground">Status:</p>
            <Badge className={`px-3 py-1 text-xs font-medium ${getStatusColor(currentSubmission.status)}`}>
              {getStatusLabel(currentSubmission.status)}
            </Badge>

            <p className="text-sm text-muted-foreground">Casa:</p>
            <p className="font-medium text-foreground">{currentSubmission.casa || "-"}</p>

            <p className="text-sm text-muted-foreground">Tipo Comissão:</p>
            <p className="font-medium text-foreground">{currentSubmission.tipo_comissao || "-"}</p>

            <p className="text-sm text-muted-foreground">Observações:</p>
            <p className="font-medium text-foreground">{currentSubmission.observacoes || "-"}</p>
          </CardContent>
        </Card>
      </div>
    )}
